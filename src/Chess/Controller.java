...
public class Controller
{
	...
	{
		Piece piece = board.getChessBoardSquare(x, y).getPiece();
...
//						System.out.println("\n------------------------------------------------------------------------------------------- CHECK 4 BLACK");
	...
	public void possibleMovesForPiece(Piece piece, Position positionCheck)
	{	
...
//			System.out.print("\nPossible moves for King at " + position + ": ");
	...
	public String coordinateToPosition(int x1, int y1)
	{	
		char column = (char) (x1 + 65);
		String row = ""+(y1+1);
		String position = column + row;
